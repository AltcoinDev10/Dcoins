...
wget https://github.com/comunidaddcoins/Dcoins/releases/download/1.0.0/dcoins-linux-gnu.tar.gz
tar -xzf dcoins-linux-gnu.tar.gz
...
echo "Use the address above to send your DCO coin  s to this server"
